  ...
  return (
    <>
      {exId ? (
        <>
          <div
            onMouseDown={(e) => info.resizeElement(exId, info)}
        ...
        <>
          <div
            onMouseDown={(e) => info.resizeElement(id, info)}
            className=" hidden absolute group-hover:block -bottom-[3px] -right-[3px] w-[10px] h-[10px] cursor-nwse-resize bg-green-500 z-[99999]"
          ></div>
          <div
            onMouseDown={(e) => info.resizeElement(id, info)}
      ...
      <div
        ...
        className=" hidden absolute group-hover:block -top-[3px] -left-[3px] w-[10px] h-[10px] cursor-nwse-resize bg-green-500 z-[99999]"
      ></div>
