            ...
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((d, i) => (
              <div className=" relative group w-full h-[170px] px-2" key={i}>
                <Link className=" w-full h-full block bg-[#ffffff12] p-4 rounded-md">
                  <img className=" w-full h-full rounded-md overflow-hidden" src="http://localhost:5173/Arpit.jpg"></img>
                </Link>
                <div className=" absolute hidden cursor-pointer top-2 right-2 text-red-500 p-2 transition duration-500 group-hover:block"><FaTrash/></div>
              </div>
            ))}
          </Carousel>
        </div>
